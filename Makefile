...
VERSION = 6.0
abs_builddir = /root/watchdog-6.0
abs_srcdir = /root/watchdog-6.0
abs_top_builddir = /root/watchdog-6.0
abs_top_srcdir = /root/watchdog-6.0
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/watchdog-6.0/install-sh
